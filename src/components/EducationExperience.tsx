          ...
          >
            <div className="education">
              ...
              <div className="bg-[#22333D] rounded-lg p-6">
                <h3 className="text-3xl font-bold mb-2">Binus University</h3>
                <p className="text-[#C6AC8E] mb-4">2022 - Present</p>
                <h4 className="text-2xl font-bold mb-2">COMPUTER SCIENCE</h4>
              </div>
            </div>
